        ...
        public class MeshChannelsCache
        {
            ...
            void _generateTangents(int[] triangles, Vector3[] verts, Vector2[] uvs, Vector3[] normals, Vector4[] outTangents)
            {
                ...
                for (int a = 0; a < triangleCount; a += 3)
                {
                    ...
                    {
#if  DEVELOPMENT_BUILD || UNITY_EDITOR
                        Debug.Log("Could not compute tangents. All UVs need to form a valid triangles in UV space. If any UV triangles are collapsed, tangents cannot be generated.");
#endif
                        return;
                    }
                    float r = 1.0f / rBot;
